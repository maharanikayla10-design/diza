...
keteranganTugas.textContent = "Klik teks untuk mencoret. Klik dua kali untuk mengubah. Seret untuk mengubah urutan.";
...
const kutipanCadangan = [
    { content: "Tidak harus hebat untuk memulai, tetapi harus memulai untuk menjadi hebat.",author: "Zig Ziglar"},
    { content: "Belajar sedikit setiap hari akan membawa perubahan besar.",author: "DailyBoard"},
    { content: "Jangan takut salah, karena kesalahan adalah bagian dari belajar.",author: "DailyBoard"},
    { content: "Langkah kecil hari ini adalah kemajuan untuk hari esok.",author: "DailyBoard"},
    { content: "Tetap mencoba, tetap belajar, dan jangan mudah menyerah.",author: "DailyBoard"}
];
